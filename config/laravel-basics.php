...
return [
    ...
    'enable' => [
        ...
        'disable_query_log' => env('APP_ENV') == 'production',
        'fake_sleep' => env('APP_ENV') == 'testing',
        'force_https_scheme' => env('APP_ENV') == 'production',
        'http_client_global_timeout' => 30,
        ...
        'prevent_stray_http_requests' => env('APP_ENV') == 'testing',
        ...
        'trust_proxies' => env('APP_ENV') == 'production',
        'unguard_models' => true,
